    ...
    return (
        <section id="content" className="py-7 container mx-auto px-[2%]">
            ...
            <div className="flex items-center justify-center my-3">
                ...
                <h1 className="bg-[#006EB6] h-fit px-5 py-3 text-4xl text-white rounded-full w-fit">محتوي الدوره</h1>
            </div>


            <div className=" flex items-center justify-between">

                <ul className="space-y-4  text-xl md:text-3xl ">
            ...
            <div className="px-5 ">
                <h2 className="bg-[#B8DFF4] mt-5 w-fit text-center text-3xl md:text-3xl p-2 rounded-md">لو أنت واحد من ال 4 اشخاص دوول فالكلام الجاي ده ليك أنت </h2>
            ...
            <div className=" flex flex-col items-center">
                ...
                <button className="w-fit bg-[#FFCC01] text-xl md:text-3xl  font-semibold py-5 px-8 rounded-full duration-200 hover:bg-[#eaca4a] my-6">احجز استشاره مجانيه دلوقتي من هنا</button>
            </div>
        </section>
    )
}
