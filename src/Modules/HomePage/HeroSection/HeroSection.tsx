...
export default function HeroSection() {
  return (
    <section id="hero" className="bg-gradient-to-r from-[#997A00] to-[#FFCC00]  pb-10 lg:pb-0 flex flex-col-reverse lg:flex-row justify-between items-center">
      ...
      <div className="flex flex-col w-full lg:w-[50%] h-screen  justify-center items-center">
      ...
      <div className="md:self-start lg:flex hidden lg:w-[50%] h-screen relative">
        <img src={egg} className="h-screen absolute left-0 top-0  object-contain md:object-cover" alt="" />
        <img src={eng} className="h-screen absolute left-0 top-0  object-contain md:object-cover" alt="" />
      </div>
    </section>
  )
}
